  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-2xl mx-auto">
        ...
        {/* How you use B Media section */}
        <div className="bg-white border-b border-gray-200 mt-8">
          <div className="px-4 py-3 border-b border-gray-100">
            <h2 className="text-lg font-medium text-gray-500">How you use B Media</h2>
          </div>
          {howYouUseBMediaItems.map((item, index) => renderSettingsItem(item, index))}
        </div>
        ...
        <div className="bg-white mt-8">
          {devicePermissionsItems.map((item, index) => renderSettingsItem(item, index))}
        </div>
      </div>
    </div>
  );
